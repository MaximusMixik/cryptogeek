(() => {
    ...
    class MagneticItem {
        constructor() {
            ...
            this.magneticBlock = this.isMobile ? document.querySelector("[data-magnetic] .button-cta") : document.querySelector("[data-magnetic]");
        ...
        _onScroll() {
            ...
            const showThreshold = this._getShowThreshold();
            const hideThreshold = this._getHideThreshold();
            if (scrollY >= showThreshold && scrollY < hideThreshold) this._enableFixed(); else this._disableFixed();
        }
        init() {
